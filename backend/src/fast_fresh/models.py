...
class Product (models.Model):
    ...
    provider = models.ForeignKey( 'Provider', on_delete=models.CASCADE, null=False, blank=False)

    def __str__(self):
        return self.product_name

class Batch (models.Model):
    product_name = models.ForeignKey('Product', on_delete=models.CASCADE, null=False, blank=False)
...
class Product_Type (models.Model):
    product_name = models.ForeignKey('Product', on_delete=models.CASCADE, null=False, blank=False)
    type_of_product = models.ForeignKey('Type_Of_Product', on_delete=models.CASCADE, null=False, blank=False)
...
class Client (models.Model):
    ...
    client_gender = models.CharField(max_length=1, choices=GENDER, blank=False, null=False)
...
class StoreBoss(models.Model):
    store = models.OneToOneField('Store', on_delete=models.CASCADE, null=False, blank=False)
    boss = models.OneToOneField('Employee', on_delete=models.CASCADE, null=False, blank=False)
...
class Delivery (models.Model):
    ...
    delivery_status = models.CharField( max_length=15, choices=STATUS, blank=False, null=False)
    zona = models.ForeignKey('Zona', on_delete=models.CASCADE, null=False, blank=False)
    address = models.CharField(max_length=200)

class PickUp (models.Model):
    STATUS = ('Entregado', ('Entregado')), ('No Entregado', ('No Entregado'))
    pickup_status = models.CharField(max_length=15, choices=STATUS, blank=False, null=False)
    bill_id = models.ForeignKey('Bill', on_delete=models.CASCADE, null=False, blank=False)

class Bill (models.Model):
    client_id = models.ForeignKey('Client', on_delete=models.CASCADE, null=False, blank=False)
    bill_sub_total = models.FloatField()
    bill_iva = models.ForeignKey('IVA', on_delete=models.CASCADE, null=False, blank=False, default=None)
...
class BillDetails (models.Model):
    bill_id = models.ForeignKey('Bill', on_delete=models.CASCADE, null=False, blank=False)
    product_batch_id = models.ForeignKey('Batch', on_delete=models.CASCADE, null=False, blank=False)
...
class CashRegisterBills(models.Model):
    cash_register = models.ForeignKey('CashRegister', on_delete=models.CASCADE, null=False, blank=False)
    bill = models.ForeignKey(
        'Bill', on_delete=models.CASCADE, null=False, blank=False)

class Payment(models.Model):
    payment_amount = models.FloatField()
    payment_method = models.ForeignKey('PaymentMethod', on_delete=models.CASCADE, null=False, blank=False)
...
class ExchangeRate (models.Model):
    origin_currency = models.ForeignKey('Currency', on_delete=models.CASCADE, null=False, blank=False)
...
class Employee (models.Model):
    ...
    employee_gender = models.CharField(max_length=1, choices=GENDER, blank=False, null=False)
    employee_birth_date = models.DateField()
    employee_phone = models.IntegerField()
    employee_job = models.ForeignKey('Job', on_delete=models.CASCADE, null=False, blank=False)
    is_active = models.BooleanField()
...
class EmployeeStore(models.Model):
    employee_store = models.ForeignKey('Store', on_delete=models.CASCADE, null=False, blank=False)
    employee = models.ForeignKey('Employee', on_delete=models.CASCADE, null=False, blank=False)
