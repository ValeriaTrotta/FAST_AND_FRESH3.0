...
def query_set_3(request,*args, **kwargs): #Top 5 productos más vendidos (Analizando los productos vendidos de cada batch). Suma las unidades vendidas de los batchs con el mismo nombre
...
#Un JSON se establece con {}
    ...
    query = Batch.objects.values('product_name__product_name').annotate(a=Sum('units_sold')).order_by('-a')[0:5]
    ...
    #iuyg8yt8yv8yt(request , MesI, MesF)
