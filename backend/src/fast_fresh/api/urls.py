...
router.register(r'type_of_product', Type_Of_ProductViewSet, basename='type_of_product')
...
router.register(r'cashregisterbills', CashRegisterBillsViewSet, basename='cashregisterbills')
...
router.register(r'employeestore', EmployeeStoreViewSet, basename='employeestore')
router.register(r'job', JobViewSet, basename='job')
router.register(r'iva', IVAViewSet, basename='iva')
router.register(r'provider', ProviderViewSet, basename='provider')
router.register(r'providerphone', ProviderPhoneViewSet, basename='providerphone')
